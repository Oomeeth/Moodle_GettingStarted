<?php
  ...
  if ($ADMIN->fulltree)
  {
    ...
    $setting = new admin_setting_configtextarea('theme_custom/scsspre', get_string('rawscsspre', 'theme_custom'), get_string('rawscsspre_desc', 'theme_custom'), '', PARAM_RAW);                      
    $setting->set_updatedcallback('theme_reset_all_caches');                                                                        
    $page->add($setting);                                                                                                           
  
      // Raw SCSS to include after the content.                                                                                       
    $setting = new admin_setting_configtextarea('theme_custom/scss', get_string('rawscss', 'theme_custom'), get_string('rawscss_desc', 'theme_custom'), '', PARAM_RAW);                                                                  
    $setting->set_updatedcallback('theme_reset_all_caches');                                                                        
    $page->add($setting);
